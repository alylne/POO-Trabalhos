...
class Janela(tk.Frame):
    ...
    def criar_widgets(self):
        ...
        label_assunto = tk.Label(frame1, text='Função')
        label_assunto.grid(row=0, column=1)

        label_recebido = tk.Label(frame1, text='Data de contratação')
        ...
        # Treeview.
        self.treeview = tkk.Treeview(frame2, columns=('Nome', 'Função', 'Data de contratação'))
        self.treeview.heading('#0', text='ID')
        self.treeview.heading('#1', text='Nome')
        self.treeview.heading('#2', text='Função')
        self.treeview.heading('#3', text='Data de contratação')
